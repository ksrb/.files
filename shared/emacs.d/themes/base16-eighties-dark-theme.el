...
(let ((base00 "#2d2d2d")
  ...
  (custom-theme-set-faces
   ...
   `(show-paren-match ((t (:background ,base03 :foreground nil))))
   ...
   `(company-tooltip ((t (:background ,base01 :foreground ,base04))))

   ;; Color of text and background of selected entry in tooltip
   `(company-tooltip-selection ((t (:background ,base04 :foreground ,base01))))
   ;; Color of text of selected entry in tooltip
   `(company-tooltip-common ((t (:foreground ,base05))))
   `(company-tooltip-search ((t (:inherit company-tooltip-selection))))

   `(company-preview ((t (:background ,base02 :foreground ,base0A))))
   ;; Color of text to preview completion when there is only one match
   `(company-preview-common ((t (:inherit company-preview :foreground ,base0D))))
   `(company-preview-search ((t (:inherit company-preview :foreground ,base08))))

   ;; Color of annotation for type such as functions <f>
   `(company-tooltip-annotation ((t (:foreground ,base0D))))
   ;; End Company
